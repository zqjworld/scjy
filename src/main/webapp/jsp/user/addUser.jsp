...
<body class="content1">
	<div class="header">
		<h1 class="page-title">山财大二手交易-添加用户</h1>
	</div>

	<ul class="breadcrumb">
		<li><a href="<%=basePath %>user/getAllUser">用户管理</a> <span
								...
								<td>
									<div class="btn-toolbar">
										<input type="submit" class="btn btn-primary"
											style="background: #dea32c;" value="保存 " onclick="saveUser()"> <a
